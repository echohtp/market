...
export default function EditionPage({ edition, doIt, open }: EditionPageProps) {
    ...
    const product = {
        ...
        href: '#',
        breadcrumbs: [
            { id: 1, name: edition.creator, href: `../creator/${edition.creator}` },
            // { id: 1, name: "banana", href: "Banana twitter" },
        ],
        images: [
            {
                id: 1,
